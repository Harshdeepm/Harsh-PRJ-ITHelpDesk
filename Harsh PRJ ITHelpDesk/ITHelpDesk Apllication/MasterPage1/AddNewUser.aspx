...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentBody" runat="server">
    <div align="center">
        <h3 style="font-family: 'Cambria Math'; font-size: x-large; font-weight: lighter; font-style: normal; color:GrayText">Add New User In The System</h3>
        <table style="width: 400px">
            ...
            <tr align="left">
                ...
                <td><asp:TextBox ID="TextPanNo" runat="server"></asp:TextBox></td>
            </tr>
            <tr align="left">
            ...
            <tr align="left">
                <td><asp:Label ID="lblSelPriority" runat="server" Text="Selection Priority"></asp:Label></td>
                <td><asp:TextBox ID="TextSelPriority" runat="server"></asp:TextBox></td>
            </tr>
            <tr align="left">
